...
$account_image = !empty($user['profpicture']) ? $user['profpicture'] : 'default.jpg'; // Default image if no profile picture is provided
...
// Fetch completed tasks and arrange them by priority
