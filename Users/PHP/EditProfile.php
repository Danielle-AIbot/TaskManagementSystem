...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $profile_image = !empty($_FILES['profile_image']['name']) ? $_FILES['profile_image']['name'] : $user['profpic'];
    $password = $_POST['password'] ?? '';

    // Handle image upload
    if (!empty($_FILES['profile_image']['name'])) {
        $target_dir = "../../admins/profile/";
    ...
    // Update user (OOP)
    $crud->U($user_id, $username, $user['email'], $profile_image, $user['role'], $hashed_password);
